...
public class SoyIcons {
  ...
  public static final Icon FILE = IconLoader.getIcon("/icons/closure-template.png", SoyIcons.class);

  static final Icon CODE_CALL = IconLoader.getIcon("/icons/call.png", SoyIcons.class);
